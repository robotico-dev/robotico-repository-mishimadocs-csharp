...
/// <summary>
/// MishimaDocs <see cref="Robotico.Repository.IUnitOfWork"/> that performs no extra persistence: each <see cref="MishimaDocsRepository{TEntity, TId}"/> operation already commits through MishimaDocs.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class MishimaDocsUnitOfWork : Robotico.Repository.IUnitOfWork, Robotico.Repository.IUnitOfWorkCapabilities
{
